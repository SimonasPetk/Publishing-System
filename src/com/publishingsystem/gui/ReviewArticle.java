...
public class ReviewArticle {
	...
	private void initialize(ReviewerOfSubmission ros, ReviewerMainWindow rmw) {
		...
		frmReviewArticle.setBounds(100, 100, 555, 655);
		frmReviewArticle.setMinimumSize(new Dimension(555, 655));
		...
		btnSubmitReview.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (summary.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Please give a summary of your review", "Error in submission",
							0);
				}
				if (typoErrors.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Please enter if there were any typing errors",
							"Error in submission", 0);
				}
				if (!criticismsOK) {
					JOptionPane.showMessageDialog(null, "Please give fill all criticism fields", "Error in submission",
							0);
				}
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(120)
						.addComponent(lblArticleReviews, GroupLayout.PREFERRED_SIZE, 237, Short.MAX_VALUE).addGap(120))
				.addGroup(groupLayout.createSequentialGroup().addGap(150)
						.addComponent(btnSubmitReview, GroupLayout.PREFERRED_SIZE, 223, Short.MAX_VALUE).addGap(150))
				...
				.addGroup(groupLayout.createSequentialGroup().addGap(190)
						.addComponent(btnAddCriticism, GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE).addGap(190))
				.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblCriticisms)
						.addContainerGap(404, Short.MAX_VALUE))
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE).addContainerGap())
				.addGroup(
						groupLayout.createSequentialGroup().addContainerGap()
								.addComponent(lblTypoErrors, GroupLayout.PREFERRED_SIZE, 173,
										GroupLayout.PREFERRED_SIZE)
								.addContainerGap(334, Short.MAX_VALUE))
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(scrTypo, GroupLayout.DEFAULT_SIZE, 454, Short.MAX_VALUE).addContainerGap())
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addComponent(scrPaneReview1, GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE).addContainerGap())
				.addGroup(groupLayout.createSequentialGroup().addContainerGap().addComponent(lblReview)
						.addContainerGap(327, Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(10).addComponent(lblArticleReviews).addGap(10).addComponent(lblReview)
				.addGap(10).addComponent(scrPaneReview1, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)
				.addGap(10).addComponent(lblTypoErrors, GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
				.addGap(10).addComponent(scrTypo, GroupLayout.PREFERRED_SIZE, 61, GroupLayout.PREFERRED_SIZE).addGap(10)
				.addComponent(lblCriticisms).addGap(10)
				.addComponent(scrollPane_1, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE).addGap(10)
				.addComponent(btnAddCriticism).addPreferredGap(ComponentPlacement.RELATED).addComponent(lblNewLabel)
				.addGap(10)
				.addComponent(comboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE)
				.addGap(20).addComponent(btnSubmitReview).addContainerGap(25, Short.MAX_VALUE)));
	...
	/*
	 * private String popUp(String criticism) { String ans = null; JPanel panel =
	 * new JPanel();
	 * 
	 * 
	 * JScrollPane scrPaneCriticism = new JScrollPane();
	 * scrPaneCriticism.setVerticalScrollBarPolicy(ScrollPaneConstants.
	 ...
	 * 
	 * JLabel lblYourAnswer = new JLabel("New Criticism"); lblYourAnswer.setFont(new
	 * Font("Tahoma", Font.PLAIN, 15));
	 * 
	 * JScrollPane scrPaneAnswer = new JScrollPane();
	 * scrPaneAnswer.setVerticalScrollBarPolicy(ScrollPaneConstants.
	 * VERTICAL_SCROLLBAR_ALWAYS);
	 * 
	 * 
	 * GroupLayout gl_panel = new GroupLayout(panel); gl_panel.setHorizontalGroup(
	 * gl_panel.createParallelGroup(Alignment.LEADING)
	 * .addGroup(gl_panel.createSequentialGroup() .addContainerGap()
	 * .addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
	 * .addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup() .addGap(250)
	 * .addComponent(lblAnswerToCriticism, GroupLayout.DEFAULT_SIZE, 234,
	 * Short.MAX_VALUE) .addGap(250)) .addGroup(Alignment.TRAILING,
	 * gl_panel.createSequentialGroup()
	 * .addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
	 * .addComponent(scrPaneAnswer, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
	 * 649, Short.MAX_VALUE) .addComponent(lblYourAnswer, Alignment.LEADING,
	 * GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
	 * .addComponent(scrPaneCriticism, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
	 * 593, Short.MAX_VALUE) .addComponent(lblCriticism, Alignment.LEADING,
	 * GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE))
	 * .addContainerGap()))) ); gl_panel.setVerticalGroup(
	 * gl_panel.createParallelGroup(Alignment.LEADING)
	 * .addGroup(gl_panel.createSequentialGroup() .addGap(10)
	 * .addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
	 * .addGroup(gl_panel.createSequentialGroup()
	 * .addComponent(lblAnswerToCriticism, GroupLayout.PREFERRED_SIZE, 19,
	 * GroupLayout.PREFERRED_SIZE) .addGap(25))
	 * .addGroup(gl_panel.createSequentialGroup() .addComponent(lblCriticism,
	 * GroupLayout.PREFERRED_SIZE, 19, GroupLayout.PREFERRED_SIZE)
	 * .addPreferredGap(ComponentPlacement.RELATED)))
	 * .addPreferredGap(ComponentPlacement.RELATED) .addComponent(scrPaneCriticism,
	 * GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE) .addGap(10)
	 * .addComponent(lblYourAnswer, GroupLayout.PREFERRED_SIZE, 19,
	 * GroupLayout.PREFERRED_SIZE) .addGap(10) .addComponent(scrPaneAnswer,
	 * GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE) .addGap(10)) );
	 * 
	 ...
	 * editPaneCriticsm.setText(criticism); editPaneCriticsm.setEditable(false);
	 * scrPaneCriticism.setViewportView(editPaneCriticsm);
	 * panel.setLayout(gl_panel);
	 * 
	 * int result = JOptionPane.showConfirmDialog(null, panel, "Data Entry",
	 * JOptionPane.OK_CANCEL_OPTION);
	 * 
	 * if (result == JOptionPane.OK_OPTION && !editPaneAnswer.getText().isEmpty()) {
	 * ans = editPaneAnswer.getText(); return ans; } else if (result ==
	 * JOptionPane.OK_OPTION && editPaneAnswer.getText().isEmpty()) {
	 * JOptionPane.showMessageDialog(new JPanel(), "You haven't entered criticism",
